...
module.exports.todo = async function todo(req,res,next,todoId) {
  try {
    const response = await Tasks.todo(todoId,req,res)
    utils.writeJson(res, response);
  }
  catch (e) {
    next(e);
...
module.exports.updateTodo = async function updateTodo(req,res,next,body,todoId) {
  try {
    const response = await Tasks.updateTodo(body,todoId,req,res)
    utils.writeJson(res, response);
  }
  catch (e) {
    next(e);
